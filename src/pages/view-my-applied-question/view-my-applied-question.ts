...
/**
 * Generated class for the ViewMyAppliedQuestionPage page.
 *
...
@IonicPage({
  ...
  segment:'page-view-my-applied-question/listingId/:listingId'
})
@Component({
  selector: 'page-view-my-applied-question',
  templateUrl: 'view-my-applied-question.html',

})
export class ViewMyAppliedQuestionPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ViewMyAppliedQuestionPage');
   this.ViewMyAppliedQuestionAnswer();
  }


    ViewMyAppliedQuestionAnswer(){
      let ListingId="";
     // let user_token="";
        ...
        this.serviceprovider.getMyQuestionAnswer(this.user).subscribe((Response)=>{
          ...
          if(Response.success == false){
            ...
            if(this.answerlist){
             ...
             if(this.answerlist[index].opt_name && this.isJson(this.answerlist[index].opt_name)){
              ...
              if(this.answerlist[index].optid && this.isJson(this.answerlist[index].optid)){
                this.answerlist[index].optid=JSON.parse(this.answerlist[index].optid);
            }
